    ...
    <div>
        <div class="d-flex flex-column gap-2">
            <div class="d-flex jus gap-2">
                ...
                <button class="btn border w-100 py-4">Acquisition</button>
                <button class="btn border w-100 py-4">Placements</button>
                    ...
                    <tbody>
                        <tr v-for="(company, index) in companies" :key="index">
                            ...
                            <td scope="row">
                                ...
                                <router-link class="icon" :to="'/companies/' + company._id">{{ company.name
                                    }}</router-link>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu p-2">
                                    ...
                                    <router-link class=" dropdown-item icon"
                                        :to="'/companies/' + company._id">Edit</router-link>
